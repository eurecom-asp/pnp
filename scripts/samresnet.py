...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load("checkpoints/asv/samresnet100.pt"))
    # model.eval()
    # torch.save(model, "checkpoints/asv/samresnet100_full.pt")
    out = model(x)
    sums = out.sum()
    grad = torch.autograd.grad(sums, x)[0]
