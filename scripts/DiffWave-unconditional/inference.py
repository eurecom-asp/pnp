...
from util import rescale, find_max_epoch, print_size, sampling, calc_diffusion_hyperparams,puri_sampling
...
def generate(output_directory, tensorboard_directory,
    ...
    raise SystemExit(
        "This release does not ship a hard-coded demo waveform. "
        "Use the repository scripts with your own input/output paths."
    )
    end.record()
