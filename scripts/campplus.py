...
if __name__ == '__main__':
    ...
    # print(out.shape)
    model = CAMPPlus(feat_dim=80, embed_dim=512, pooling_func='TSTP')
    # load pretrained model for test
    # dic = torch.load("checkpoints/asv/campplus.pt")
    #  delete  Unexpected key(s) in state_dict: "projection.weight".
    # dic.pop("projection.weight", None)
    # model.load_state_dict(dic)
    # save full model
    # torch.jit.script(model).save("checkpoints/asv/campplus_jit.pt")
