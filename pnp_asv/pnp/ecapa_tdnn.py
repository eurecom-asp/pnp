...
class AAMSoftmax(nn.Module):
    ...
    def forward(self, features):
        ...
        phi = cosine * self.m + sine
        phi = torch.log_softmax(phi, dim=1)
        return phi
...
class ECAPA_TDNN(nn.Module):
    def __init__(self,
        ...
        # self.AAMSoftmax = AAMSoftmax(num_classes=1251, feature_size=192)
...
if __name__ == '__main__':
    ...
    model = ECAPA_TDNN_GLOB_c1024(feat_dim=80,
                                 embed_dim=192,
